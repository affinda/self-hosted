...
variable celery_worker_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/affinda-selfhosted:6.33.79"
}
...
variable ocr_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/ocr:6.33.79"
}

variable text_extraction_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/text_extraction:6.33.79"
}

variable pdfkit_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/pdfkit:6.33.79"
}

variable inference_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/affinda-inference-selfhosted-resumes:6.33.79"
}

variable libreoffice_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/libre_office:6.33.79"
}

variable redis_image {
  default = "335594571162.dkr.ecr.ap-southeast-2.amazonaws.com/affinda-redis:6.33.79"
}
